...
fn write_image(
    ...
    if let Err(image_error) = encoder.write_image(pixels, bounds.0 as u32, bounds.1 as u32, ExtendedColorType::L8) {
        return match image_error {
            ImageError::IoError(e) => Err(e),
...
mod tests {
    use num::Complex;
    use crate::{parse_pair, parse_complex, pixel_to_point};
